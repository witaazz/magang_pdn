...
<form action="{{ route('save.mapel') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="flex flex-col gap-2">
        ...
        <input type="pengajar" name="pengajar" value="{{ old('pengajar') }}" class="p-2 border rounded-md">
    ...
    <div class="flex flex-col gap-2">
        ...
        <input type="text" name="lokal" value="{{ old('lokal') }}" class="p-2 border rounded-md">
